...
using System.Linq;
using System.Web;
using TestCatalogoProductos.Models;

namespace TestCatalogoProductos.database_access_layer
{
    /// <summary>
    /// Auto: JR
    /// Description: esta clase fue contruida para fines de pruebas
    /// </summary>
    [Obsolete("Not used any more, contruida para fines de pruebas by JR")]
    public class db
    {

        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConCatalogoProducto"].ConnectionString);
